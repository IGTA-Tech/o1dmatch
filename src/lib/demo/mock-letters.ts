...
export const DEMO_INTEREST_LETTERS: InterestLetter[] = [
  {
    ...
    job_id: 'job-1',
    application_id: null,
    commitment_level: CommitmentLevel.FIRM_COMMITMENT,
...
- Drive technical direction for critical AI initiatives`,
  ...
  },
  {
    ...
    job_id: 'job-2',
    application_id: null,
    commitment_level: CommitmentLevel.INTENT_TO_ENGAGE,
...
- Serve as the company's public face for medical AI initiatives`,
  ...
  },
  {
    ...
    job_id: 'job-5',
    application_id: null,
    commitment_level: CommitmentLevel.CONDITIONAL_OFFER,
...
- Represent our protocol at major blockchain conferences and with partners`,
  ...
  },
  {
    ...
    job_id: 'job-4',
    application_id: null,
    commitment_level: CommitmentLevel.OFFER_EXTENDED,
...
- Mentor junior composers and build our in-house music team`,
  ...
  },
  {
    ...
    commitment_level: CommitmentLevel.EXPLORATORY_INTEREST,
...
I would welcome the opportunity to discuss how my background can contribute to your groundbreaking work in AI.`,
    ...
    criteria_met_at_application: [O1Criterion.AWARDS, O1Criterion.SCHOLARLY_ARTICLES, O1Criterion.ORIGINAL_CONTRIBUTIONS, O1Criterion.JUDGING, O1Criterion.CRITICAL_ROLE],
    status: ApplicationStatus.LETTER_SENT,
    employer_rating: 5,
...
I'd love to discuss how design thinking can enhance AI research and product development.`,
    ...
    criteria_met_at_application: [O1Criterion.AWARDS, O1Criterion.PUBLISHED_MATERIAL, O1Criterion.JUDGING, O1Criterion.CRITICAL_ROLE],
...
I am excited about the opportunity to work on practical quantum computing applications and would welcome the chance to discuss how I can contribute to Quantum Dynamics' mission.`,
    ...
    criteria_met_at_application: [O1Criterion.SCHOLARLY_ARTICLES, O1Criterion.ORIGINAL_CONTRIBUTIONS, O1Criterion.MEMBERSHIPS],
    status: ApplicationStatus.LETTER_SENT,
    employer_rating: 5,
...
I would love to bring this experience to FinTech Global and help build the future of decentralized finance.`,
    ...
    criteria_met_at_application: [O1Criterion.ORIGINAL_CONTRIBUTIONS, O1Criterion.SCHOLARLY_ARTICLES, O1Criterion.HIGH_SALARY],
...
I would be honored to bring my artistic vision to Creative Studios' upcoming projects.`,
    ...
    criteria_met_at_application: [O1Criterion.AWARDS, O1Criterion.PUBLISHED_MATERIAL, O1Criterion.CRITICAL_ROLE, O1Criterion.HIGH_SALARY],
    status: ApplicationStatus.LETTER_SENT,
    employer_rating: 5,
...
I am passionate about applying AI to improve patient outcomes and would welcome the opportunity to lead Innovate Health's medical AI initiatives.`,
    ...
    criteria_met_at_application: [O1Criterion.AWARDS, O1Criterion.SCHOLARLY_ARTICLES, O1Criterion.ORIGINAL_CONTRIBUTIONS, O1Criterion.HIGH_SALARY, O1Criterion.CRITICAL_ROLE],
