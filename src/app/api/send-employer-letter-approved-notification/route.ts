// src/app/api/send-employer-letter-approved-notification/route.ts
//
// Sends an email to the employer's signatory when their interest letter
// has been approved by an admin and delivered to the talent.
...
function buildEmployerApprovedHtml({
  signatoryName,
  companyName,
  jobTitle,
  commitmentLevel,
...
<head>
  ...
  <title>Interest Letter Approved – O1DMatch</title>
</head>
          ...
          <tr>
            <td style="background:#0B1D35;border-radius:16px 16px 0 0;
              ...
              <h1 style="margin:0;font-size:26px;font-weight:700;
                ...
                Your Interest Letter is Approved &#10003;
              </h1>
              <p style="margin:12px 0 0;font-size:14px;
                         color:rgba(255,255,255,0.58);line-height:1.5;">
                It has been reviewed and delivered to the candidate.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#FFFFFF;padding:36px 40px;">
              ...
              <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.7;">
                Great news! Your Interest Letter from
                <strong style="color:#0B1D35;">${companyName}</strong>
                for the <strong style="color:#0B1D35;">${jobTitle}</strong> position
                has been reviewed and approved by our team. It has now been
                delivered to the candidate for their review.
              </p>
                ...
                <tr>
                  <td style="padding:20px 24px 8px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      ${detailRow('Approved On', approvedAt)}
                    </table>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:12px 0;border-bottom:1px solid #F1F5F9;vertical-align:middle;">
                    ...
                    <span style="font-size:14px;color:#374151;vertical-align:middle;">
                      The candidate will review your interest letter on their dashboard.
                    </span>
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 0;border-bottom:1px solid #F1F5F9;vertical-align:middle;">
                    ...
                    <span style="font-size:14px;color:#374151;vertical-align:middle;">
                      If they accept, our team will initiate the O-1 sponsorship process.
                    </span>
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 0;vertical-align:middle;">
                    ...
                    <span style="font-size:14px;color:#374151;vertical-align:middle;">
                      You can track all sent letters in your
                      <a href="https://app.o1dmatch.com/dashboard/employer/letters"
              ...
              <p style="margin:0;font-size:13px;color:#9CA3AF;line-height:1.7;">
                ...
                Contact details are shared once the candidate accepts the letter.
              </p>
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!apiKey) {
      console.error('[send-employer-letter-approved-notification] SENDGRID_API_KEY is not set');
    ...
    await sendEmail(
      apiKey,
      toEmail,
      `Your interest letter for "${jobTitle}" has been approved – O1DMatch`,
      buildEmployerApprovedHtml({
    ...
    console.log('[send-employer-letter-approved-notification] Email sent to:', toEmail);
    return NextResponse.json({ success: true });

  } catch (err) {
    console.error('[send-employer-letter-approved-notification] Unexpected error:', err);
    return NextResponse.json({ error: 'Failed to send employer notification email' }, { status: 500 });
  }
}