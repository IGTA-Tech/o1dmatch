...
- Expertise in transformers and attention mechanisms`,
    ...
    start_date: null,
    min_score: 75,
    preferred_criteria: ['scholarly_articles', 'awards', 'original_contributions'],
...
- Published research in medical AI or clinical informatics`,
    ...
    min_score: 80,
    preferred_criteria: ['original_contributions', 'critical_role', 'scholarly_articles'],
...
- Strong programming skills (Python, C++)`,
    ...
    start_date: null,
    min_score: 70,
    preferred_criteria: ['scholarly_articles', 'original_contributions', 'memberships'],
...
- Strong relationships with orchestras and musicians`,
    ...
    start_date: null,
    min_score: 75,
    preferred_criteria: ['awards', 'published_material', 'critical_role'],
...
- Understanding of cryptographic primitives`,
    ...
    start_date: null,
    min_score: 65,
    preferred_criteria: ['original_contributions', 'scholarly_articles', 'high_salary'],
...
- Experience with industrial automation`,
    ...
    min_score: 80,
    preferred_criteria: ['original_contributions', 'critical_role', 'awards'],
...
- Excellent communication skills`,
    ...
    start_date: null,
    min_score: 85,
    preferred_criteria: ['scholarly_articles', 'original_contributions', 'judging'],
...
- Experience with clinical translation`,
    ...
    min_score: 75,
    preferred_criteria: ['scholarly_articles', 'original_contributions', 'awards'],
