// src/app/(dashboard)/dashboard/admin/articles/new/page.tsx
"use client";
...
export default function NewArticlePage() {
  ...
  const handleSubmit = async (publishNow = false) => {
    ...
    const status = publishNow ? "published" : articleStatus;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-0.5 text-sm">
              Create a new blog post or content piece
            </p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              {showPreview ? (
                ...
                <textarea
                  ...
                  placeholder="Write your article content here... (paste or write HTML directly)"
                  rows={20}
